...
Serving through [NVIDIA Dynamo](https://github.com/ai-dynamo/dynamo) instead? Point the gateway at the Dynamo
frontend the same way; see [Running Agentic API in front of NVIDIA Dynamo](docs/guides/dynamo-upstream.md).
